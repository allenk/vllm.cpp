...
<p align="center">
  ...
  <sub>Continuous batching, paged KV, 47 registered architectures, CUDA / CPU / Metal / Vulkan. No Python anywhere.</sub>
</p>
...
- **Everything.** 47 registered architectures, 38 tool-parser families, structured output including
...
<details>
<summary><b>The full architecture matrix</b> (47 registered architectures grouped by family)</summary>
...
to the C++ registry (all 47 registered architectures with their tested checkpoint and gate, plus the
